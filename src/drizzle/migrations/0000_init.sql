...
CREATE TYPE "public"."is_Available" AS ENUM('active', 'inactive');--> statement-breakpoint
CREATE TYPE "public"."product_status" AS ENUM('available', 'unavailable', 'out_of_stock', 'discontinued');--> statement-breakpoint
...
CREATE TABLE "products" (
	...
	"dimensions" varchar,
	"brand" varchar,
	"is_available" "is_Available" DEFAULT 'active' NOT NULL,
	"category_id" integer NOT NULL,
