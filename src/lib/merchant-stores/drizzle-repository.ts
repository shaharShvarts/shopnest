...
function mapStore(row: typeof stores.$inferSelect): MerchantStore {
  return {
    ...
    activationRequestedAt: row.activationRequestedAt,
    provisioningStartedAt: row.provisioningStartedAt,
    provisionedAt: row.provisionedAt,
    lastProvisioningAttemptAt: row.lastProvisioningAttemptAt,
    provisioningAttemptCount: row.provisioningAttemptCount,
    lastProvisioningErrorCode: row.lastProvisioningErrorCode,
