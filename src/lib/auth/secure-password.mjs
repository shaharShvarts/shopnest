...
export async function hashSecurePassword(password, label = "Password") {
  if (typeof password !== "string" || password.length < 12) {
    throw new Error(`${label} must contain at least 12 characters`);
  }
...
export async function verifySecurePassword(password, encodedHash) {
  try {
